...
class CompletableFuture_thenApply4 {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        CompletableFuture<String> future = CompletableFuture.supplyAsync(() -> "Некоторый результат")
...
/*
    Більше того, якщо ви передасте Executor в thenApplyAsync() , завдання буде виконано в потоці, отриманому з пулу 
    потоків Executor.
...
class CompletableFuture_thenCombine {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        // Колбек, переданий методу theCombine() , викликається, коли обидві завдання завершаться.
...
class CompletableFuture_handle {
    ...
    /*
        Ой! У нас тут исключение - java.lang.IllegalArgumentException: Вік не може мати від'ємне значення
        Зрілість: Невідомо!
     */
}